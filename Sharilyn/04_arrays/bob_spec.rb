...
describe Bob do
  ...
  it "responds to shouting" do
    assert_equal 'Whoa, chill out!', teenager.hey('WATCH OUT!')
  end
  ...
  it "responds to forceful questions" do
    ##skip
    assert_equal 'Whoa, chill out!', teenager.hey('WHAT THE HELL WERE YOU THINKING?')
  end

  it "responds to shouting with numbers" do
    ##skip
    assert_equal 'Whoa, chill out!', teenager.hey('1, 2, 3 GO!')
  end

  it "responds to shouting with special characters" do
    ##skip
    assert_equal 'Whoa, chill out!', teenager.hey('ZOMG THE %^*@#$(*^ ZOMBIES ARE COMING!!11!!1!')
  end

  it "responds to shouting with no exclamation points" do
    ##skip
    assert_equal 'Whoa, chill out!', teenager.hey('I HATE YOU')
  end
