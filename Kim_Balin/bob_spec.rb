...
no})
  ...
  it "responds to only numbers" do #16
    assert_equal 'Whatever.', teenager.hey('1, 2, 3')
  end

  it "responds to questions with only numbers" do #17
